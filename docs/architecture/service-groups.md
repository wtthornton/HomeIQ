...
| device-context-classifier | 8032 | Device *type* classification from entity capability signatures (fridge, car, 3D printer archetypes). No HomeIQ service infers rooms/areas (TAP-6229) |
