...
**Implementation Location**: `domains/core-platform/websocket-ingestion/src/influxdb_wrapper.py` (Epic 31 - migrated from enrichment-pipeline)
...
1. **`integration` tag** - Identifies the source integration (zwave, mqtt, zigbee, homekit, etc.)
   ...
   - Implementation: `domains/core-platform/websocket-ingestion/src/influxdb_wrapper.py` (Epic 31 - migrated)
