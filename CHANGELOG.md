...
- **Phase 3 ML prerequisites tracking and rollback script enhancements** (06c028c) - Bill Thornton
- **cross-group bearer token auth — ServiceAuthValidator, CrossGroupClient migration** (b99aef7) - Bill Thornton
- **group-level health dashboard — /health/groups endpoint, GroupsTab redesign** (2af65d4) - Bill Thornton
- **AI fallback with CircuitBreaker across 4 services + proactive-agent breakers** (d885f05) - Bill Thornton
- **cross-group integration test workflow — 5 jobs, test fixtures** (98e6609) - Bill Thornton
