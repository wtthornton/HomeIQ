...
class WebhookNotificationChannel(NotificationChannel):
    ...
    async def send_notification(self, alert: Alert) -> bool:
        ...
        try:
            ...
            logging.exception(f"Failed to send webhook notification: {e}")
            return False
...
class SlackNotificationChannel(NotificationChannel):
    ...
    async def send_notification(self, alert: Alert) -> bool:
        ...
        try:
            ...
            logging.exception(f"Failed to send Slack notification: {e}")
            return False
    ...
    async def _evaluation_loop(self):
        ...
        while self.is_evaluating:
            try:
                ...
                logging.exception(f"Error in alert evaluation loop: {e}")
...
class AlertingService:
    ...
    def add_notification_channel(self, name: str, channel_type: str, config: dict[str, Any]):
        ...
        if channel_type == "email":
            ...
            msg = f"Unknown notification channel type: {channel_type}"
