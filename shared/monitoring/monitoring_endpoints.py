...
class MetricsQuery(BaseModel):
    ...
    start_time: str | None = None
    end_time: str | None = None
    interval: str | None = None  # e.g., "1m", "5m", "1h"
    ...
    def _setup_routes(self):
        ...
        async def get_logs(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to retrieve logs: {e!s}") from e
        ...
        async def get_log_statistics(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to retrieve log statistics: {e!s}") from e
        ...
        async def compress_logs(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to compress logs: {e!s}") from e
        ...
        async def cleanup_old_logs(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to cleanup logs: {e!s}") from e
        ...
        async def get_current_metrics(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to retrieve current metrics: {e!s}") from e
        ...
        async def get_metrics_summary(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to retrieve metrics summary: {e!s}") from e
        ...
        async def get_alerts(
            ...
            try:
                ...
                from shared.monitoring.alerting_service import AlertSeverity, AlertStatus
                status_enum = None
                severity_enum = None
                ...
                raise HTTPException(status_code=500, detail=f"Failed to retrieve alerts: {e!s}") from e
        ...
        async def get_active_alerts(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to retrieve active alerts: {e!s}") from e
        ...
        async def get_alert_statistics(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to retrieve alert statistics: {e!s}") from e
        ...
        async def resolve_alert(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to resolve alert: {e!s}") from e
        ...
        async def get_dashboard_overview(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to retrieve dashboard overview: {e!s}") from e
        ...
        async def get_dashboard_health(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to retrieve dashboard health: {e!s}") from e
        ...
        async def get_alert_rules(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to retrieve alert rules: {e!s}") from e
        ...
        async def create_alert_rule(
            ...
            try:
                ...
                raise HTTPException(status_code=400, detail=f"Failed to create alert rule: {e!s}") from e
        ...
        async def update_alert_rule(
            ...
            try:
                ...
                raise HTTPException(status_code=400, detail=f"Failed to update alert rule: {e!s}") from e
        ...
        async def delete_alert_rule(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to delete alert rule: {e!s}") from e
        ...
        async def create_notification_channel(
            ...
            try:
                ...
                raise HTTPException(status_code=400, detail=f"Failed to create notification channel: {e!s}") from e
        ...
        async def export_logs(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to export logs: {e!s}") from e
        ...
        async def export_metrics(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to export metrics: {e!s}") from e
        ...
        async def export_alerts(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to export alerts: {e!s}") from e
