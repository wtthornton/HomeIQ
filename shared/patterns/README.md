...
**Module:** `shared/patterns/rag_context_service.py`
...
`services/ha-ai-agent-service/src/services/automation_rag_service.py` — Sports/Team Tracker RAG
...
**Module:** `shared/patterns/rag_context_registry.py`
...
`services/ha-ai-agent-service/src/services/context_builder.py` — Registry initialized in `ContextBuilder.initialize()`
...
**Module:** `shared/patterns/unified_validation_router.py`
...
`services/ai-automation-service-new/src/api/automation_yaml_validate_router.py` — Automation YAML validation
...
**Module:** `shared/patterns/post_action_verifier.py`
...
`services/ai-automation-service-new/src/services/automation_deploy_verifier.py` — Automation deploy verification
...
Phase 3 implementations (Epic: High-Value Domain Extensions):
  services/ha-ai-agent-service/src/services/
  ...
  services/ha-ai-agent-service/src/data/
  ...
  services/ai-automation-service-new/src/api/
...
```bash
cd c:\cursor\HomeIQ
python -m pytest shared/patterns/tests/ -v
```
