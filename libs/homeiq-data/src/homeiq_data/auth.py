...
class AuthManager:
    ...
    def __init__(
        ...
        *,
        ...
        logger.info("Authentication manager initialized (anonymous=%s)", self.allow_anonymous)
    ...
    def configure_auth(self, api_key: str | None, enable_auth: bool | None = None):
        ...
        if enable_auth is False and not self.allow_anonymous:
            logger.warning("Ignoring request to disable authentication – this toggle is deprecated")
        self.api_key = api_key
