...
class ServiceClient:
    ...
    def __init__(
        self, service_name: str, base_url: str, timeout: float = 5.0, max_retries: int = 3
    ):
        """
...
def get_service_client(
    service_name: str, base_url: str | None = None, timeout: float = 5.0
) -> ServiceClient:
    """
    ...
    if service_name not in _service_clients:
        ...
        _service_clients[service_name] = ServiceClient(
            service_name=service_name, base_url=base_url, timeout=timeout
        )
