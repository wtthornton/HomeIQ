...
class AlertManager:
    ...
    _CONDITIONS: ClassVar[dict[str, Callable[[float, float], bool]]] = {
        ">": operator.gt,
        ">=": operator.ge,
        "<": operator.lt,
        "<=": operator.le,
    ...
    def _evaluate_condition(self, value: float, condition: str, threshold: float) -> bool:
        """Evaluate alert condition. An unknown operator never fires."""
        compare = self._CONDITIONS.get(condition)
        return compare(value, threshold) if compare else False
