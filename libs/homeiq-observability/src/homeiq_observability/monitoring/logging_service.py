...
class LogAggregator:
    ...
    def __init__(self, log_dir: str | None = None):
        ...
        # File handlers are attached lazily: creating directories and mutating
        # the root logger are side effects that must not happen on import.
        self._handlers_ready = False

    def _ensure_log_sink(self):
        """Create the log directory and attach file handlers, once."""
