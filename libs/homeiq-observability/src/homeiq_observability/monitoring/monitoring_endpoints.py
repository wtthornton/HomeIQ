    ...
    def _setup_routes(self):
        ...
        async def get_logs(
            ...
            try:
                logs = logging_service.get_recent_logs(
                    limit=limit, level=level, service=service, component=component
                )
                ...
                return {
                    ...
                    "data": {
                        "logs": logs,
                        "count": len(logs),
                        "filters": {"level": level, "service": service, "component": component},
                    },
        ...
        async def compress_logs(
            ...
            try:
                ...
                raise HTTPException(
                    status_code=500, detail=f"Failed to compress logs: {str(e)}"
                ) from e
        ...
        async def cleanup_old_logs(
            ...
            try:
                ...
                return {
                    "success": True,
                    "data": {"deleted_files": deleted_count, "days_to_keep": days_to_keep},
                ...
                raise HTTPException(
                    status_code=500, detail=f"Failed to cleanup logs: {str(e)}"
                ) from e
        ...
        async def get_metrics_summary(
            ...
            try:
                ...
                raise HTTPException(
                    status_code=500, detail=f"Failed to retrieve metrics summary: {str(e)}"
                ) from e
        ...
        async def get_alerts(
            ...
            try:
                ...
                alerts = alert_manager.get_alert_history(
                    limit=limit, status=status_enum, severity=severity_enum
                )
        ...
        async def get_dashboard_health(
            ...
            try:
                ...
                overall_healthy = all(services_healthy.values()) and len(critical_alerts) == 0
                ...
                raise HTTPException(
                    status_code=500, detail=f"Failed to retrieve dashboard health: {str(e)}"
                ) from e
        ...
        async def get_alert_rules(
            ...
            try:
                ...
                raise HTTPException(
                    status_code=500, detail=f"Failed to retrieve alert rules: {str(e)}"
                ) from e
        ...
        async def update_alert_rule(
            ...
            try:
                ...
                raise HTTPException(
                    status_code=400, detail=f"Failed to update alert rule: {str(e)}"
                ) from e
        ...
        async def create_notification_channel(
            ...
            try:
                ...
                raise HTTPException(
                    status_code=400, detail=f"Failed to create notification channel: {str(e)}"
                ) from e
        ...
        async def export_logs(
            ...
            try:
                ...
                if format == "json":
                    return {
                        "success": True,
                        "data": {"logs": logs, "format": "json", "count": len(logs)},
                        "timestamp": datetime.now().isoformat(),
                    }
                elif format == "csv":
                ...
                raise HTTPException(
                    status_code=500, detail=f"Failed to export logs: {str(e)}"
                ) from e
        ...
        async def export_alerts(
            ...
            try:
                ...
                raise HTTPException(
                    status_code=500, detail=f"Failed to export alerts: {str(e)}"
                ) from e
