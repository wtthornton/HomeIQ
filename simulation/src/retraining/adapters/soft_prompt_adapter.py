...
class SoftPromptDataAdapter:
    ...
    def __init__(self, pg_url: str = POSTGRES_URL):
        ...
        """
        self.pg_url = pg_url
        logger.info(f"SoftPromptDataAdapter initialized with PostgreSQL")

    def prepare_training_database(self, json_path: Path) -> str:
        """
    ...
    def _create_table(self) -> None:
        ...
        try:
            cursor.execute("""
                CREATE TABLE IF NOT EXISTS automation.ask_ai_queries (
            ...
            cursor.execute("""
                ...
                ON automation.ask_ai_queries(created_at DESC)
            """)
    ...
    def _populate_database(self, soft_prompt_data: list[dict[str, Any]]) -> None:
        ...
        try:
            ...
            cursor.execute("DELETE FROM automation.ask_ai_queries")
            ...
            for entry in soft_prompt_data:
                ...
                cursor.execute("""
                    INSERT INTO automation.ask_ai_queries (
