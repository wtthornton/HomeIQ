...
from src.database.crud import get_synergy_opportunities, get_synergy_stats, store_synergy_opportunities
...
async def list_synergies(
    ...
    try:
        ...
        logger.info(f"Router received parameters - synergy_type type: {type(synergy_type)}, value: {synergy_type!r}")
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve synergies: {e!s}")
...
async def get_synergy_detail(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get synergy detail: {e!s}")
...
async def detect_synergies_realtime(
    ...
    try:
        ...
        try:
            ...
            logger.exception("Synergy detection timed out after 100 seconds")
            raise HTTPException(
                status_code=504,
        ...
        raise HTTPException(status_code=500, detail=f"Failed to detect synergies: {e!s}")
