...
async def discover_blueprint_opportunities_for_query(
    ...
    logger.debug("Blueprint discovery disabled - automation miner integration removed")
    return []
...
# Model comparison endpoints moved to api/ask_ai/model_comparison_router.py (Epic 39.13)
# See: services/ai-automation-service/src/api/ask_ai/model_comparison_router.py
...
# Model comparison summary endpoint moved to api/ask_ai/model_comparison_router.py (Epic 39.13)
# See: services/ai-automation-service/src/api/ask_ai/model_comparison_router.py
