...
class MultiFactorPatternDetector(MLPatternDetector):
    ...
    def __init__(
        self,
        time_factors: list[str] | None = None,
        presence_factors: list[str] | None = None,
        ...
        **kwargs,
        ...
        if weather_factors is None:
            weather_factors = ["temperature", "humidity", "conditions"]
        if presence_factors is None:
            presence_factors = ["presence", "room_occupancy"]
