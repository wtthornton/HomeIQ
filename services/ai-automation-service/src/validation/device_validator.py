...
class DeviceValidator:
    ...
    async def validate_automation_suggestion(
        ...
        try:
            ...
            logger.exception(f"Device validation failed: {e}")
            return ValidationResult(
                is_valid=False,
                missing_devices=[],
                missing_entities=[],
    ...
    async def validate_trigger_condition(self, condition: str) -> ValidationResult:
        ...
        try:
            ...
            logger.exception(f"Trigger condition validation failed: {e}")
            return ValidationResult(
                is_valid=False,
                missing_devices=[],
                missing_entities=[],
    ...
    async def get_available_sensor_types(self) -> dict[str, list[str]]:
        ...
        try:
            ...
            logger.exception(f"Failed to get available sensor types: {e}")
            return {}
    ...
    async def _refresh_caches(self):
        ...
        try:
            ...
            logger.exception(f"Failed to refresh caches: {e}")
            self._entity_cache = {}
            self._device_cache = {}
