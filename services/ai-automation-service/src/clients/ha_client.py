...
class HomeAssistantClient:
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                if attempt + 1 < self.max_retries:
                    ...
                    logger.exception(f"❌ Max retries reached for {endpoint}, timeout")
                    return None
    ...
    async def get_version(self) -> dict[str, Any] | None:
        ...
        try:
            ...
            logger.exception(f"❌ Error getting HA version: {e}")
            return None
    ...
    async def test_connection(self) -> bool:
        ...
        try:
            ...
            logger.exception(f"❌ Failed to connect to HA: {e}")
            return False
    ...
    async def get_automation(self, automation_id: str) -> dict | None:
        ...
        for attempt in range(max_retries):
            try:
                ...
                logger.exception(f"Error getting automation {automation_id}: {e}")
                return None
    ...
    async def enable_automation(self, automation_id: str) -> bool:
        ...
        try:
            ...
            logger.exception(f"Error enabling automation {automation_id}: {e}")
            return False
    ...
    async def disable_automation(self, automation_id: str) -> bool:
        ...
        try:
            ...
            logger.exception(f"Error disabling automation {automation_id}: {e}")
            return False
    ...
    async def trigger_automation(self, automation_id: str) -> bool:
        ...
        try:
            ...
            logger.exception(f"Error triggering automation {automation_id}: {e}")
            return False
    ...
    async def conversation_process(self, text: str) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"Failed to process conversation with HA: {e}")
    ...
    async def create_automation(self, automation_yaml: str, automation_id: str | None = None, force_new: bool = True) -> dict[str, Any]:
        ...
        try:
            ...
            if not isinstance(automation_data, dict):
                msg = "Invalid automation YAML: must be a dict"
