...
from ...services.yaml_structure_validator import YAMLStructureValidator, ValidationResult as StructureValidationResult
...
class AutomationYAMLValidator:
    ...
    async def _validate_entities(self, yaml_content: str, context: Optional[Dict]) -> ValidationStage:
