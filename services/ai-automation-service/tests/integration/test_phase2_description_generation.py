...
async def test_light_capability_parsing():
    ...
    assert capabilities["supported_features"]["brightness"]
    assert capabilities["supported_features"]["rgb_color"]
    assert capabilities["supported_features"]["color_temp"]
    assert capabilities["supported_features"]["transition"]
...
async def test_climate_capability_parsing():
    ...
    assert capabilities["supported_features"]["temperature"]
    assert capabilities["supported_features"]["hvac_mode"]
    assert capabilities["supported_features"]["fan_mode"]
    assert capabilities["supported_features"]["preset"]
