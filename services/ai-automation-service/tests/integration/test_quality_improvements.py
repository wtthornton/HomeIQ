...
from src.pattern_analyzer.co_occurrence import CoOccurrencePatternDetector, EXCLUDED_DOMAINS, ACTIONABLE_DOMAINS, TRIGGER_DOMAINS
...
class TestMLSynergyStorage:
    ...
    async def test_discovered_synergy_storage(self):
        ...
        from sqlalchemy.ext.asyncio import create_async_engine, AsyncSession, async_sessionmaker
        from src.database.models import Base, DiscoveredSynergy as DiscoveredSynergyDB
