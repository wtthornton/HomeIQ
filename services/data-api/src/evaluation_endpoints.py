...
async def _get_store():
    ...
    if _store is None:
        from shared.patterns.evaluation import EvaluationStore
...
def _get_scheduler():
    ...
    if _scheduler is None:
        from shared.patterns.evaluation import EvaluationRegistry, EvaluationScheduler
...
def _get_alert_engine():
    ...
    if _alert_engine is None:
        from shared.patterns.evaluation import AlertEngine
...
async def trigger_evaluation(agent_name: str):
    ...
    engine = _get_alert_engine()
    try:
        from shared.patterns.evaluation import ConfigLoader
