...
class ModelOrchestrator:
    ...
    async def _try_ner_extraction(self, query: str, confidence_threshold: float) -> list[dict[str, Any]] | None:
    ...
    async def _try_openai_extraction(self, query: str) -> tuple[list[dict[str, Any]] | None, float]:
