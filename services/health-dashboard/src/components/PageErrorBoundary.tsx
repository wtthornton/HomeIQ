            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <button
                  ...
                  className={`w-full mt-3 px-4 py-2 rounded-lg font-medium transition-colors border ${
                    darkMode
...
/**
 * Hook-based wrapper for PageErrorBoundary that provides darkMode detection
 */
