...
Epic 39: Migrated from archived ai-automation-service
"""
...
class MultiModalContextEnhancer:
    ...
    def __init__(self, context_fetcher: Optional[Any] = None):
        """
        Initialize multi-modal context enhancer.
        
        Args:
            context_fetcher: Optional context fetcher for external data (weather, energy, etc.)
                            Can be None - will use defaults if unavailable
        """
    ...
    async def _fetch_with_retry(
        ...
        Args:
            ...
            fetch_func: Async function to call, or None if not available
