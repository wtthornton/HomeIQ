...
class VersioningService:
    ...
    def __init__(self, db: AsyncSession, ha_client: HomeAssistantClient | None = None):
        """
    ...
    async def create_version(
        ...
        if previous_version:
            ...
            yaml_diff = self._calculate_diff(previous_version.automation_yaml, automation_yaml)
    ...
    async def get_latest_version(
        self, suggestion_id: int | None = None, automation_id: str | None = None
    ...
    async def get_version_history(
        self, automation_id: str, limit: int = 10
    ...
    async def restore_state(
        self, automation_id: str, version_number: int | None = None
    ) -> dict[str, Any]:
        """
        ...
        return {"restored": restored, "failed": failed, "version_number": version.version_number}
