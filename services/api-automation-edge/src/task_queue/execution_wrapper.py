...
_rest_client: HARestClient | None = None
_websocket_client: HAWebSocketClient | None = None
_spec_registry: SpecRegistry | None = None
...
_capability_graph: CapabilityGraph | None = None
