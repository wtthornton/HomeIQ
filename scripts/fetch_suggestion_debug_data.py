...
def get_suggestion_from_query(query_id: str, suggestion_id: str) -> Optional[Dict[str, Any]]:
...
def format_markdown(suggestion: Dict[str, Any], query_id: Optional[str] = None) -> str:
