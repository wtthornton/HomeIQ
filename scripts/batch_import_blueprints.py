...
BLUEPRINT_SOURCES = [
    ...
    },
    {
        ...
        "url": "https://raw.githubusercontent.com/home-assistant/core/dev/homeassistant/components/automation/blueprints/zone_notification.yaml",
        "category": "notifications",
        "description": "Send a notification to a device when a person leaves a specific zone"
    },
    # Community blueprints from EPMatt/awesome-ha-blueprints
    {
        "name": "On-Off schedule with state persistence",
        "url": "https://raw.githubusercontent.com/EPMatt/awesome-ha-blueprints/main/blueprints/automation/on_off_schedule_state_persistence.yaml",
        "category": "scheduling",
        "description": "A simple on-off schedule with state persistence across disruptive events"
    },
    {
        "name": "Simple Safe Scheduler",
        "url": "https://raw.githubusercontent.com/EPMatt/awesome-ha-blueprints/main/blueprints/automation/simple_safe_scheduler.yaml",
        "category": "scheduling",
        "description": "Scheduling with built-in safety checks to ensure actions run even after outages"
    },
    {
        "name": "Wake-up light alarm with sunrise effect",
        "url": "https://raw.githubusercontent.com/BeardedTinker/Home-Assistant_Config/main/blueprints/automation/wake_up_light_alarm_with_sunrise_effect.yaml",
        "category": "lighting",
        "description": "Wake-up light alarm with brightness and color temperature sunrise effect"
    },
]
    ...
    async with get_db_context() as session:
        ...
        if existing_blueprint:
            ...
            for key, value in blueprint.__dict__.items():
                if key not in ['id', 'created_at', '_sa_instance_state']:  # Don't overwrite ID, created_at, or SQLAlchemy state
