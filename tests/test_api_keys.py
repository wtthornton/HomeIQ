...
class APITestResult:
    ...
    def set_success(self, details: dict[str, Any] | None = None):
        """Mark test as successful"""
        self.success = True
        if details:
            self.details.update(details)

    def set_error(self, error: str, details: dict[str, Any] | None = None):
        """Mark test as failed"""
        self.success = False
        self.error = error
        if details:
...
class HomeAssistantAPITester:
    ...
    async def test_connection(self) -> APITestResult:
        ...
        try:
            ...
            result.set_error(f"Connection error: {e!s}")
        except Exception as e:
            result.set_error(f"Unexpected error: {e!s}")
    ...
    async def test_websocket_connection(self) -> APITestResult:
        ...
        try:
            ...
            result.set_error(f"WebSocket test error: {e!s}")
    ...
    async def test_token_permissions(self) -> APITestResult:
        ...
        try:
            ...
            result.set_error(f"Permission test error: {e!s}")
...
class WeatherAPITester:
    ...
    async def test_api_key_validity(self) -> APITestResult:
        ...
        try:
            ...
            result.set_error(f"Network error: {e!s}")
        except Exception as e:
            result.set_error(f"Unexpected error: {e!s}")
    ...
    async def test_location_weather(self, location: str) -> APITestResult:
        ...
        try:
            ...
            result.set_error(f"Location test error: {e!s}")
    ...
    async def test_api_quota(self) -> APITestResult:
        ...
        try:
            ...
            result.set_error(f"Quota test error: {e!s}")
...
class EnvironmentValidator:
    ...
    def load_environment(self) -> APITestResult:
        ...
        try:
            ...
            for var_name, _description in required_vars.items():
            ...
            result.set_error(f"Environment loading error: {e!s}")
