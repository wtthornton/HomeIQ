...
# Created: 2026-02-05T14:41:13.000681

set -e

SERVICE_DIR="C:\cursor\HomeIQ\services\websocket-ingestion"
BACKUP_DIR="C:\cursor\HomeIQ\services\websocket-ingestion\.migration_backup_mqtt_20260205_144112"

echo "Rolling back MQTT migration for websocket-ingestion..."
