...
class TestEvaluationModels:
    ...
    def test_history_response(self):
        ...
        r = HistoryResponse(agent_name="test", scores=[], total=0, page=1, page_size=10)
        assert r.total == 0
    ...
    def test_health_response(self):
        ...
        r = HealthResponse(
            status="running", registered_agents=["a1"], batch_size=10, timestamp="now"
        )
