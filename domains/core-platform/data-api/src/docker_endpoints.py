...
class DockerEndpoints:
    ...
    def _add_routes(self):
        ...
        async def stop_container(service_name: str = Path(..., description="Service name to stop")):
        ...
        async def get_container_stats(service_name: str = Path(..., description="Service name")):
        ...
        async def get_api_key_status(service: str = Path(..., description="Service name")):
