...
# Created: 2026-02-05T14:18:52.540668

set -e

SERVICE_DIR="C:\cursor\HomeIQ\services\openvino-service"
BACKUP_DIR="C:\cursor\HomeIQ\services\openvino-service\.migration_backup_20260205_141845"

echo "Rolling back pytest-asyncio migration for openvino-service..."
