...
# Created: 2026-02-05T14:19:00.994473

set -e

SERVICE_DIR="C:\cursor\HomeIQ\services\openvino-service"
BACKUP_DIR="C:\cursor\HomeIQ\services\openvino-service\.migration_backup_tenacity_20260205_141852"

echo "Rolling back tenacity migration for openvino-service..."
...
echo "Run 'docker-compose build openvino-service' to rebuild with old versions"
