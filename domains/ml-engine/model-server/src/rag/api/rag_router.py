...
async def update_success_score(id: int, request: UpdateSuccessRequest, service: RAGServiceDep) -> UpdateSuccessResponse:
    """
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to update success score: {str(e)}") from e
