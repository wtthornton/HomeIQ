...
from ..clients.openvino_client import LocalOpenVINOBridge
...
def get_openvino_client(request: Request) -> LocalOpenVINOBridge:
...
def get_rag_service(
    request: Request,
    db: DatabaseSession,
    openvino_client: Annotated[LocalOpenVINOBridge, Depends(get_openvino_client)],
) -> RAGService:
