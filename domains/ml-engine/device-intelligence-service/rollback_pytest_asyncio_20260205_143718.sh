...
# Created: 2026-02-05T14:37:18.956452

set -e

SERVICE_DIR="C:\cursor\HomeIQ\services\device-intelligence-service"
BACKUP_DIR="C:\cursor\HomeIQ\services\device-intelligence-service\.migration_backup_20260205_143718"

echo "Rolling back pytest-asyncio migration for device-intelligence-service..."
