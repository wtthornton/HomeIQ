    ...
    for home_type in HOME_TYPES:
        ...
        try:
            ...
            training_data = generator.generate_training_data(
                count=samples_per_type, days=days, failure_rate=failure_rate, home_type=home_type
            )
...
def main():
    ...
    parser.add_argument(
        "--days", type=int, default=180, help="Number of days of historical data (default: 180)"
    )
    parser.add_argument(
        "--failure-rate",
        type=float,
