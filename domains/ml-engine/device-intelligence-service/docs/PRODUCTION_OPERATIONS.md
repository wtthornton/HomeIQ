...
# Add this line:
0 2 * * 0 cd /path/to/domains/ml-engine/device-intelligence-service && python scripts/train_models.py --force --days-back 180 >> training.log 2>&1
```

**Monthly Training (1st of month at 2 AM):**

```bash
0 2 1 * * cd /path/to/domains/ml-engine/device-intelligence-service && python scripts/train_models.py --force --days-back 180 >> training.log 2>&1
```
...
# Add to crontab
0 2 * * 0 /path/to/domains/ml-engine/device-intelligence-service/scripts/schedule_model_training.sh
```
...
tail -f domains/ml-engine/device-intelligence-service/training.log
```
...
cd domains/ml-engine/device-intelligence-service/models
