...
**Location:** `domains/automation-core/ai-automation-service-new/src/synergy_detection/gnn_synergy_detector.py`
...
**Location:** `domains/automation-core/ai-automation-service-new/src/correlation/tabpfn_predictor.py`
...
**Location:** `domains/ml-engine/device-intelligence-service/src/core/predictive_analytics.py`
...
**Location:** `domains/ml-engine/device-intelligence-service/src/core/tabpfn_predictor.py` (new)
...
**Location:** `domains/ml-engine/device-intelligence-service/src/core/incremental_predictor.py` (new)
...
cd domains/ml-engine/device-intelligence-service
