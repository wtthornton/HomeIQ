...
class TestWLEDHandler:
    ...
    def test_get_relationships_segment_to_master(self):
        ...
        handler = WLEDHandler()
        segment_device = {"id": "segment1", "name": "Office WLED Segment 1", "manufacturer": "WLED"}
        all_devices = [
            segment_device,
            {"id": "master1", "name": "Office WLED", "manufacturer": "WLED"},
        ]
    ...
    def test_get_relationships_master_to_segments(self):
        ...
        handler = WLEDHandler()
        master_device = {"id": "master1", "name": "Office WLED", "manufacturer": "WLED"}
        all_devices = [
            master_device,
            {"id": "segment1", "name": "Office WLED Segment 1", "manufacturer": "WLED"},
            {"id": "segment2", "name": "Office WLED Segment 2", "manufacturer": "WLED"},
        ]
