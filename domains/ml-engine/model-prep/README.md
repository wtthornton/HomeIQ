...
docker build -t homeiq-model-prep -f domains/ml-engine/model-prep/Dockerfile domains/ml-engine/model-prep
...
services:
  model-prep:
    build:
      context: ./domains/ml-engine/model-prep
...
- [AI Automation Service Model Management](../../automation-core/ai-automation-service-new/README-PHASE1-MODELS.md)
- [Docker Optimization Plan](../../../docs/DOCKER_OPTIMIZATION_PLAN.md)
- [Model Manager Implementation](../../automation-core/ai-automation-service-new/src/models/model_manager.py)
