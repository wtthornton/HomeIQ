...
class TestTrainingCRUD:
    ...
    @pytest.mark.asyncio
    async def test_create_training_run(self, test_db: AsyncSession, sample_training_run_data):
    ...
    @pytest.mark.asyncio
    async def test_get_active_training_run_none(self, test_db: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_update_training_run(self, test_db: AsyncSession, sample_training_run_data):
    ...
    @pytest.mark.asyncio
    async def test_update_training_run_not_found(self, test_db: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_list_training_runs(self, test_db: AsyncSession, sample_training_run_data):
    ...
    @pytest.mark.asyncio
    async def test_delete_training_run(self, test_db: AsyncSession, sample_training_run_data):
    ...
    @pytest.mark.asyncio
    async def test_delete_training_run_not_found(self, test_db: AsyncSession):
        """Test deleting a non-existent training run."""
        deleted = await delete_training_run(test_db, 999)
        assert deleted is False

    @pytest.mark.asyncio
    async def test_delete_old_training_runs(self, test_db: AsyncSession, sample_training_run_data):
        ...
        deleted_count = await delete_old_training_runs(test_db, older_than_days=30, keep_recent=10)
