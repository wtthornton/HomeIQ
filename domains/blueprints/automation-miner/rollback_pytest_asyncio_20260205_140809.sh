...
# Created: 2026-02-05T14:08:09.611970

set -e

SERVICE_DIR="C:\cursor\HomeIQ\services\automation-miner"
BACKUP_DIR="C:\cursor\HomeIQ\services\automation-miner\.migration_backup_20260205_140804"

echo "Rolling back pytest-asyncio migration for automation-miner..."
...
echo "Run 'docker-compose build automation-miner' to rebuild with old versions"
