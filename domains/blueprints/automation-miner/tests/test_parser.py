...
"""
    ...
    def test_extract_integrations(self, parser):
        ...
        automation = {"trigger": [{"platform": "mqtt", "topic": "test"}]}
    ...
    def test_calculate_complexity_low(self, parser):
        ...
        automation = {"trigger": [{"platform": "state"}], "action": [{"service": "light.turn_on"}]}
    ...
    def test_calculate_quality_score(self, parser):
        ...
        score1 = parser.calculate_quality_score(votes=1000, age_days=30, completeness=1.0)
        assert score1 >= 0.8

        # Low votes, old, incomplete
        score2 = parser.calculate_quality_score(votes=10, age_days=700, completeness=0.3)
        assert score2 < 0.5
