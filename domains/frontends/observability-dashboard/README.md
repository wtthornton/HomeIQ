...
pip install -r domains/frontends/observability-dashboard/requirements.txt

# Run Streamlit locally
cd domains/frontends/observability-dashboard
...
```bash
# Run tests
pytest domains/frontends/observability-dashboard/tests/
```
