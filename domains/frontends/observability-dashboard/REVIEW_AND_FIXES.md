...
**Note:** docker-compose.yml line 213 confirms `8004:8004`, but `domains/core-platform/admin-api/src/stats_endpoints.py:27` references `http://localhost:8003`. This needs project-wide reconciliation.
