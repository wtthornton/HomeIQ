...
class ServiceInventory:
    ...
    def get_service(self, domain: str, service: str) -> dict[str, Any] | None:
        """Get service by domain and service name"""
        service_key = f"{domain}.{service}"
        return self.services.get(service_key)

    def get_service_schema(self, domain: str, service: str) -> dict[str, Any] | None:
        """Get service schema"""
        service_key = f"{domain}.{service}"
        return self.service_schemas.get(service_key)

    def get_capability_service(self, capability: str) -> tuple[str, str] | None:
        """
