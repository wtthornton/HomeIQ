...
# Created: 2026-02-05T14:39:41.702681

set -e

SERVICE_DIR="C:\cursor\HomeIQ\services\api-automation-edge"
BACKUP_DIR="C:\cursor\HomeIQ\services\api-automation-edge\.migration_backup_influxdb_20260205_143941"

echo "Rolling back InfluxDB migration for api-automation-edge..."
