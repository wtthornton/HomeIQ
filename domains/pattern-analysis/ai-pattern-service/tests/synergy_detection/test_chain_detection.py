...
class TestChainDetector:
    ...
    def test_create_3_device_chain(self, detector):
        ...
        next_synergy = {"impact_score": 0.7, "confidence": 0.85, "rationale": "Second step"}
    ...
    @pytest.mark.asyncio
    async def test_detect_3_device_chains_with_cache(
    ...
    @pytest.mark.asyncio
    async def test_detect_3_device_chains_cache_hit(
        self, detector_with_cache, sample_pairwise_synergies, mock_cache
    ):
    ...
    def test_create_4_device_chain(self, detector):
        ...
        next_synergy = {"impact_score": 0.65, "confidence": 0.8, "rationale": "Fourth step"}
    ...
    async def test_detect_4_device_chains(self, detector, sample_pairwise_synergies):
        ...
        four_chains = await detector.detect_4_device_chains(three_chains, sample_pairwise_synergies)
