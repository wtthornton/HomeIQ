...
class TestIntegrationSynergyImprovements:
    ...
    @pytest.mark.asyncio
    @pytest.mark.integration
    async def test_multi_modal_context_integration(self, synergy_detector, mock_enrichment_fetcher):
    ...
    @pytest.mark.asyncio
    @pytest.mark.integration
    async def test_xai_explanation_generation(self, synergy_detector):
    ...
    @pytest.mark.asyncio
    @pytest.mark.integration
    async def test_transformer_sequence_modeling(self, synergy_detector):
    ...
    @pytest.mark.asyncio
    @pytest.mark.integration
    async def test_gnn_integration(self, synergy_detector, mock_data_api_client):
    ...
    @pytest.mark.integration
    @pytest.mark.slow
    async def test_performance_large_device_set(self, synergy_detector, mock_data_api_client):
