...
class TestSynergyCRUD:
    ...
    async def test_store_synergy_opportunities(self, test_db: AsyncSession, sample_synergy_data):
    ...
    @pytest.mark.unit
    @pytest.mark.requires_db
    async def test_store_empty_synergies(self, test_db: AsyncSession):
    ...
    @pytest.mark.unit
    @pytest.mark.requires_db
    async def test_store_multiple_synergies(self, test_db: AsyncSession, sample_synergy_data):
    ...
    @pytest.mark.unit
    @pytest.mark.requires_db
    async def test_get_synergy_opportunities(self, test_db: AsyncSession, sample_synergy_data):
    ...
    @pytest.mark.unit
    @pytest.mark.requires_db
    async def test_get_synergies_filtered_by_type(self, test_db: AsyncSession, sample_synergy_data):
        """Test retrieving synergies filtered by type."""
        # Store synergies
        await store_synergy_opportunities(test_db, [sample_synergy_data])

        # Get synergies by type
        synergies = await get_synergy_opportunities(test_db, synergy_type="device_pair")
        assert len(synergies) >= 1
    ...
    @pytest.mark.unit
    @pytest.mark.requires_db
    async def test_get_synergies_min_confidence(self, test_db: AsyncSession, sample_synergy_data):
