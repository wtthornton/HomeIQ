...
"""
    ...
    async def test_validate_automation_invalid_yaml(
        self, validator: AutomationPreDeploymentValidator, mock_ha_client: AsyncMock
    ):
    ...
    async def test_validate_automation_missing_service(
        ...
        mock_services_response = MagicMock()
        mock_services_response.status_code = 200
        mock_services_response.json = MagicMock(
            return_value={
...
"""
        ...
        mock_ha_client.get = AsyncMock(
            side_effect=[mock_entity_response, mock_entity_response, mock_services_response]
        )
    ...
    @pytest.mark.asyncio
    @pytest.mark.unit
    def test_extract_entity_ids(self, validator: AutomationPreDeploymentValidator):
    ...
    @pytest.mark.asyncio
    @pytest.mark.unit
    def test_extract_services(self, validator: AutomationPreDeploymentValidator):
