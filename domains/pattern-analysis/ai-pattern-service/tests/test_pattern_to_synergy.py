...
class TestPatternToSynergyConversion:
        ...
        return [
            {
                ...
                "pattern_metadata": {"hour": 7, "minute": 0},
                "confidence": 0.9,
                "occurrences": 30,
            },
            {
    ...
    async def test_detect_synergies_from_co_occurrence_patterns(
        self, detector: DeviceSynergyDetector, sample_co_occurrence_pattern: dict[str, Any]
    ):
    ...
    async def test_detect_synergies_from_time_patterns(
        self, detector: DeviceSynergyDetector, sample_time_patterns: list[dict[str, Any]]
    ):
    ...
    @pytest.mark.asyncio
    @pytest.mark.unit
    async def test_pattern_to_synergy_invalid_pattern(self, detector: DeviceSynergyDetector):
    ...
    @pytest.mark.asyncio
    @pytest.mark.unit
    async def test_pattern_to_synergy_missing_devices(self, detector: DeviceSynergyDetector):
    ...
    @pytest.mark.asyncio
    @pytest.mark.unit
    async def test_detect_synergies_from_empty_patterns(self, detector: DeviceSynergyDetector):
