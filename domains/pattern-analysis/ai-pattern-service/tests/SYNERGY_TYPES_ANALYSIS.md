...
```python:1650:1656:domains/pattern-analysis/ai-pattern-service/src/synergy_detection/synergy_detector.py
...
1. **Storage Logic:** Chains are combined with pairs at line 771:
   ```python:770:772:domains/pattern-analysis/ai-pattern-service/src/synergy_detection/synergy_detector.py
...
```python:1669:1686:domains/pattern-analysis/ai-pattern-service/src/synergy_detection/synergy_detector.py
...
```python:112:113:domains/pattern-analysis/ai-pattern-service/src/api/synergy_router.py
# Count by type
