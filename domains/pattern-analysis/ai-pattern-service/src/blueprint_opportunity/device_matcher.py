...
from .schemas import BlueprintSummary, DeviceSignature
...
class DeviceMatcher:
    ...
    def __init__(self, enable_wyze_scoring: bool = True):
        ...
        self._popular_patterns: list[tuple[str, float]] | None = None
    ...
    def calculate_fit_score(
        ...
        wyze_pattern_score: float | None = None,
    ...
    def _calculate_temporal_score(
        ...
        for use_case_key, months in self.SEASONAL_USE_CASES.items():
            if use_case_key in use_case and month in months:
    ...
    def group_devices_by_area(
        self,
        devices: list[DeviceSignature],
    ) -> dict[str | None, list[DeviceSignature]]:
        """
        ...
        """
        groups: dict[str | None, list[DeviceSignature]] = {}
