...
class DeviceSynergyDetector:
    ...
    def _check_relationship_match(
        ...
        if domain1 == trigger_domain and domain2 == action_domain and self._check_device_class_match(entity1, rel_config):
            return (entity1, entity2)

        # Check reverse direction: domain2 -> domain1
        if domain2 == trigger_domain and domain1 == action_domain and self._check_device_class_match(entity2, rel_config):
    ...
    def _should_skip_chain(
        ...
        if synergy.get('area') != next_synergy.get('area') and not self._is_valid_cross_area_chain(trigger_entity, synergy.get('action_entity'), next_action, entities):
            return True
