...
class DeviceComparisonEngine:
    ...
    def compare_devices(
        ...
        devices_to_compare = [d for d in devices if d.get("device_id") in device_id_set]
    ...
    def _extract_comparison_points(self, devices: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    def _generate_recommendation(self, devices: list[dict[str, Any]]) -> dict[str, Any]:
        ...
        best_device = max(devices, key=lambda d: d.get("community_rating", 0) or 0)
