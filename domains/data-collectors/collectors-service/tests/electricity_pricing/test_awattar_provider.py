...
import pytest
from src.adapters.electricity_pricing.providers.awattar import AwattarProvider
from src.adapters.electricity_pricing.providers.exceptions import ProviderParseError
