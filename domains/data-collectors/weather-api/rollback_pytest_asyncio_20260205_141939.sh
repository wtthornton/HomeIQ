...
# Service: weather-api
# Created: 2026-02-05T14:19:39.014068

set -e

SERVICE_DIR="C:\cursor\HomeIQ\services\weather-api"
BACKUP_DIR="C:\cursor\HomeIQ\services\weather-api\.migration_backup_20260205_141936"

echo "Rolling back pytest-asyncio migration for weather-api..."
...
echo "Run 'docker-compose build weather-api' to rebuild with old versions"
