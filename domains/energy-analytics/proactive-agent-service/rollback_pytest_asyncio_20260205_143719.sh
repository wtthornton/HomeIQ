...
# Created: 2026-02-05T14:37:19.932010

set -e

SERVICE_DIR="C:\cursor\HomeIQ\services\proactive-agent-service"
BACKUP_DIR="C:\cursor\HomeIQ\services\proactive-agent-service\.migration_backup_20260205_143719"

echo "Rolling back pytest-asyncio migration for proactive-agent-service..."
