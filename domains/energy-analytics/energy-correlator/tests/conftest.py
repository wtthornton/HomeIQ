...
def sample_power_data() -> dict:
    ...
    return {"before": 2450.0, "after": 2510.0, "delta": 60.0, "delta_pct": 2.45}


@pytest.fixture
def sample_large_power_change() -> dict:
    """Sample HVAC power change (large delta)"""
    return {"before": 1850.0, "after": 4350.0, "delta": 2500.0, "delta_pct": 135.14}


@pytest.fixture
def sample_negative_power_change() -> dict:
    """Sample light turning off (negative delta)"""
    return {"before": 2150.0, "after": 2030.0, "delta": -120.0, "delta_pct": -5.58}


@pytest.fixture
def sample_small_power_change() -> dict:
    """Sample small power change (below threshold)"""
    return {"before": 2450.0, "after": 2455.0, "delta": 5.0, "delta_pct": 0.20}
