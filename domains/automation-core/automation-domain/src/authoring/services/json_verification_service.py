...
from homeiq_ha.homeiq_automation.validator import HomeIQAutomationValidator, ValidationResult
...
class JSONVerificationService:
    ...
    async def verify_consistency(
        self, automation_json: dict[str, Any] | HomeIQAutomation
    ) -> dict[str, Any]:
        """
        ...
        try:
            ...
            return {"consistent": len(issues) == 0, "issues": issues, "warnings": warnings}
    ...
    async def rebuild_from_yaml(
        self, yaml_content: str, suggestion_id: int | None = None
    ) -> dict[str, Any] | None:
        """
