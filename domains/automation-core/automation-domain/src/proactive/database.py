...
#
# Read from ENERGY_DB_SCHEMA rather than DATABASE_SCHEMA (TAP-7275): the agent,
# authoring and proactive slices now share one process, and a single
# DATABASE_SCHEMA would bind all three to whichever value was set last.
_schema = os.getenv("ENERGY_DB_SCHEMA", "energy")
