...
#
# Read from AGENT_DB_SCHEMA rather than DATABASE_SCHEMA (TAP-7275): the agent,
# authoring and proactive slices share one process, and a single
# DATABASE_SCHEMA would bind all three to whichever value was set last.
_schema = os.getenv("AGENT_DB_SCHEMA", "agent")
...
class ConversationModel(Base):
    ...
    source: Mapped[str | None] = mapped_column(
        String(20), default="user", nullable=True, index=True
    )
