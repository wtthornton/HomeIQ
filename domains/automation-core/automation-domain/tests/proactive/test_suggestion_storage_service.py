...
from src.proactive.services.suggestion_storage_service import SuggestionStorageService
...
async def test_create_suggestion_raises_error_when_db_not_initialized():
    ...
    from src.proactive.services.suggestion_storage_service import (
    ...
    with (
        patch(
            "src.proactive.services.suggestion_storage_service.get_async_session_maker",
            return_value=None,
        ),
