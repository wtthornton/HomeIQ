...
class TestSharedBreakers:
    def test_core_platform_breaker_is_singleton(self):
        from src.proactive.clients.breakers import core_platform_breaker
    ...
    def test_data_collectors_breaker_is_singleton(self):
        from src.proactive.clients.breakers import data_collectors_breaker
...
def _make_data_client():
    from src.proactive.clients.data_api_client import DataAPIClient
...
def _make_weather_client():
    from src.proactive.clients.weather_api_client import WeatherAPIClient
...
def _make_sports_client():
    from src.proactive.clients.sports_data_client import SportsDataClient
...
def _make_carbon_client():
    from src.proactive.clients.carbon_intensity_client import CarbonIntensityClient
