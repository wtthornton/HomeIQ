...
from src.agent.services.entity_inventory_service import EntityInventoryService
...
@pytest.mark.asyncio
async def test_get_summary_with_device_area_resolution(
    entity_inventory_service, mock_context_builder
):
...
@pytest.mark.asyncio
async def test_get_summary_device_registry_error_graceful(
    entity_inventory_service, mock_context_builder
):
...
@pytest.mark.asyncio
async def test_get_summary_entity_registry_error_graceful(
    entity_inventory_service, mock_context_builder
):
...
async def test_get_summary_hue_room_detection(entity_inventory_service, mock_context_builder):
    ...
    mock_entities = [
        {
            "entity_id": "light.office_room",
            "domain": "light",
            "area_id": "office",
            "device_id": "hue_room_device",
        },
        {
            "entity_id": "light.office_1",
            "domain": "light",
