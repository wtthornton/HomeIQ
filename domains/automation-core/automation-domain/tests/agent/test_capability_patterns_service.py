...
from src.agent.services.capability_patterns_service import CapabilityPatternsService
...
async def test_get_patterns_with_capabilities(capability_patterns_service, mock_context_builder):
    ...
    mock_capabilities_device2 = [
        {"capability_name": "effect", "capability_type": "enum", "properties": {"count": 186}}
    ]
...
@pytest.mark.asyncio
async def test_get_patterns_device_capability_error(
    capability_patterns_service, mock_context_builder
):
