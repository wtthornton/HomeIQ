...
"""
    ...
    @pytest.mark.asyncio
    async def test_validate_yaml_fails_without_id_or_alias(
...
"""
    ...
    @pytest.mark.asyncio
    async def test_validate_yaml_fails_with_invalid_syntax(
        self, yaml_service: YAMLGenerationService
    ):
...
"""
    ...
    @pytest.mark.asyncio
    async def test_validate_yaml_fails_with_non_dict_root(
        self, yaml_service: YAMLGenerationService
    ):
...
"""
    ...
    @pytest.mark.asyncio
    async def test_validate_entities_with_invalid_entities(
        self, yaml_service: YAMLGenerationService
    ):
...
"""
    ...
    @pytest.mark.asyncio
    async def test_validate_entities_extracts_from_nested_structures(
        self, yaml_service: YAMLGenerationService
    ):
...
"""
    ...
    @pytest.mark.asyncio
    async def test_validate_entities_handles_data_api_error(
        self, yaml_service: YAMLGenerationService
    ):
...
"""
    ...
    async def test_generate_yaml_fails_without_description(
        ...
        suggestion = Suggestion(title="Test Automation", description=None, status="approved")
