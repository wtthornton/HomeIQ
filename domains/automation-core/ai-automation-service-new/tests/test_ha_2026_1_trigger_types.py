...
class TestNewTriggerTypes:
            ...
            triggers=[
                HomeIQTrigger(
                    ...
                    config=TriggerConfig(
                        entity_id="button.living_room_button", parameters={"action": "press"}
                    ),
                )
            ],
        ...
        automation = HomeIQAutomation(
            ...
            triggers=[
                HomeIQTrigger(
                    platform="climate",
                    config=TriggerConfig(
                        entity_id="climate.living_room", parameters={"mode": "heating"}
                    ),
                )
            ],
        ...
        automation = HomeIQAutomation(
            ...
            triggers=[
                HomeIQTrigger(
                    platform="climate",
                    config=TriggerConfig(
                        entity_id="climate.living_room", parameters={"temperature_threshold": 20.0}
                    ),
                )
            ],
            actions=[HomeIQAction(service="climate.set_temperature")],
        ...
        automation = HomeIQAutomation(
            ...
            triggers=[
                HomeIQTrigger(
                    ...
                    config=TriggerConfig(
                        entity_id="device_tracker.phone", parameters={"event": "entered_home"}
                    ),
                )
            ],
            actions=[HomeIQAction(service="light.turn_on")],
        ...
        automation = HomeIQAutomation(
            ...
            triggers=[
                HomeIQTrigger(
                    platform="humidifier",
                    config=TriggerConfig(
                        entity_id="humidifier.living_room", parameters={"state": "on"}
                    ),
                )
            ],
        ...
        automation = HomeIQAutomation(
            ...
            triggers=[
                HomeIQTrigger(
                    platform="light",
                    config=TriggerConfig(
                        entity_id="light.living_room", parameters={"brightness_threshold": 128}
                    ),
                )
            ],
            actions=[HomeIQAction(service="light.turn_on")],
        ...
        automation = HomeIQAutomation(
            ...
            triggers=[
                HomeIQTrigger(
                    platform="lock",
                    config=TriggerConfig(
                        entity_id="lock.front_door", parameters={"event": "unlocked"}
                    ),
                )
            ],
    ...
    def test_scene_trigger(self):
        ...
        automation = HomeIQAutomation(
            ...
            triggers=[
                HomeIQTrigger(platform="scene", config=TriggerConfig(entity_id="scene.movie_mode"))
            ],
    ...
    def test_siren_trigger(self):
        ...
        automation = HomeIQAutomation(
            ...
            triggers=[
                HomeIQTrigger(
                    platform="siren",
                    config=TriggerConfig(entity_id="siren.alarm", parameters={"state": "on"}),
                )
            ],
    ...
    def test_update_trigger(self):
        ...
        automation = HomeIQAutomation(
            ...
            triggers=[
                HomeIQTrigger(
                    platform="update", config=TriggerConfig(entity_id="update.home_assistant")
                )
            ],
...
class TestEnhancedTargeting:
    ...
    def test_trigger_with_area_targeting(self):
        ...
        automation = HomeIQAutomation(
            ...
            triggers=[
                HomeIQTrigger(
                    platform="state",
                    config=TriggerConfig(parameters={"to": "on"}),
        ...
        automation = HomeIQAutomation(
            ...
            triggers=[
                HomeIQTrigger(
                    ...
                    config=TriggerConfig(parameters={"to": "on"}),
                    target=Target(
                        area_id="living_room", floor_id="first_floor", labels=["indoor", "lighting"]
                    ),
                )
            ],
            actions=[HomeIQAction(service="light.turn_on")],
    ...
    def test_condition_with_targeting(self):
        ...
        automation = HomeIQAutomation(
            ...
            device_context=DeviceContext(entity_ids=["light.living_room"]),
            triggers=[
                HomeIQTrigger(platform="state", config=TriggerConfig(parameters={"to": "on"}))
            ],
            conditions=[
                HomeIQCondition(
                    condition="state",
...
class TestStateTriggers:
        ...
        automation = HomeIQAutomation(
            ...
            triggers=[
                HomeIQTrigger(
                    platform="state",
                    config=TriggerConfig(
                        entity_id="light.living_room", parameters={"to": "on", "from": "off"}
                    ),
                )
            ],
            actions=[HomeIQAction(service="light.turn_on")],
    ...
    def test_time_trigger(self):
        ...
        automation = HomeIQAutomation(
            ...
            device_context=DeviceContext(entity_ids=["light.living_room"]),
            triggers=[
                HomeIQTrigger(platform="time", config=TriggerConfig(parameters={"at": "08:00:00"}))
            ],
            actions=[HomeIQAction(service="light.turn_on")],
        )
        ...
        automation = HomeIQAutomation(
            ...
            triggers=[
                HomeIQTrigger(
                    platform="state",
                    config=TriggerConfig(parameters={"to": "on"}),
                    target=Target(area_id="living_room", labels=["outdoor", "security"]),
                )
            ],
            actions=[HomeIQAction(service="light.turn_on")],
        )
