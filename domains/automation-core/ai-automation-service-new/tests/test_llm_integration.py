...
"""
    ...
    @pytest.mark.asyncio
    async def test_generate_yaml_without_api_key_raises_error(self):
    ...
    async def test_generate_yaml_tracks_token_usage(
        self, openai_client: OpenAIClient, mock_openai_response
    ):
...
class TestErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_rate_limit_error_retries(self, openai_client: OpenAIClient):
...
class TestSuggestionDescriptionGeneration:
    ...
    @pytest.mark.asyncio
    async def test_generate_suggestion_description_success(self, openai_client: OpenAIClient):
...
class TestUsageStats:
    ...
    @pytest.mark.asyncio
    async def test_get_usage_stats(self, openai_client: OpenAIClient):
    ...
    @pytest.mark.asyncio
    async def test_reset_usage_stats(self, openai_client: OpenAIClient):
