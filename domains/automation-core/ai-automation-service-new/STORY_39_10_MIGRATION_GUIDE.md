...
**Reference:** `domains/automation-core/ai-automation-service/src/clients/`
...
- Reference: `domains/automation-core/ai-automation-service/src/api/suggestion_router.py` (lines 1-1680)
...
- Reference: `domains/automation-core/ai-automation-service/src/services/automation/yaml_generation_service.py`
- Key functions:
...
- Reference: `domains/automation-core/ai-automation-service/src/api/deployment_router.py`
- Key functions:
...
- Reference: `domains/automation-core/ai-automation-service/src/safety_validator.py`
...
**Reference:** `domains/automation-core/ai-automation-service/src/database/models.py`
...
ai-automation-service-new:
  build:
    context: ./domains/automation-core/ai-automation-service-new
  ...
  volumes:
    - ./domains/automation-core/ai-automation-service/data:/app/data:rw
  depends_on:
    - data-api
```
