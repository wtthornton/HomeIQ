...
### Suggestion Generation
- **Router**: `domains/automation-core/ai-automation-service/src/api/suggestion_router.py`
- **Endpoints**:
...
### YAML Generation
- **Service**: `domains/automation-core/ai-automation-service/src/services/automation/yaml_generation_service.py`
- **Functions**:
...
### Deployment
- **Router**: `domains/automation-core/ai-automation-service/src/api/deployment_router.py`
- **Endpoints**:
