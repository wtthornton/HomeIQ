...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_compiled_artifacts_created_at"), "compiled_artifacts", ["created_at"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_deployments_ha_automation_id"), "deployments", ["ha_automation_id"], unique=False
    )
