...
class TestEntityResolutionService:
    ...
    async def test_resolve_entities_with_context(self, mock_data_api_client):
        ...
        context_entities = [{"entity_id": "light.office", "friendly_name": "Office Light", "area_id": "office"}]

        result = await service.resolve_entities("turn on office light", context_entities=context_entities)
