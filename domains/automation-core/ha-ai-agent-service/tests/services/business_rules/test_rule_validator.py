...
def mock_entity_resolution_service():
    ...
    service.resolve_entities = AsyncMock(
        return_value=MagicMock(success=True, matched_entities=["light.office"], matched_areas=["office"])
    )
    return service
...
class TestBusinessRuleValidator:
    ...
    async def test_validate_entity_resolution(self, mock_entity_resolution_service):
        ...
        result = await validator.validate_entity_resolution("turn on office lights", target_domain="light")
