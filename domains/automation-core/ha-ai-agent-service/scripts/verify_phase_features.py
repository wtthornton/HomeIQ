    ...
    try:
        ...
        if state_service_file.exists():
            ...
            if "unavailable" in state_content.lower() and ("⚠️" in state_content or "warning" in state_content.lower()):
                print("  ✅ 1.3: Entity Availability Status")
            else:
                print("  ❌ 1.3: Entity Availability Status - Not found")
        else:
            print("  ❌ 1.3: device_state_context_service.py not found")
    ...
    try:
        ...
        if patterns_file.exists():
            ...
            if "AutomationPatternsService" in patterns_content:
                print("  ✅ 2.3: Recent Automation Patterns")
            else:
                print("  ⚠️  2.3: Recent Automation Patterns - Service class not found")
        else:
            print("  ❌ 2.3: Recent Automation Patterns - Service file not found")
    ...
    try:
        ...
        if prioritization_file.exists():
            ...
            if "score_entity_relevance" in content and "prioritize_entities" in content:
                print("  ✅ 3.1: Semantic Context Prioritization")
            else:
                print("  ❌ 3.1: Semantic Context Prioritization - Methods not found")
        else:
            print("  ❌ 3.1: Semantic Context Prioritization - Service file not found")
        ...
        if filtering_file.exists():
            ...
            if "extract_intent" in content and "filter_entities" in content:
                print("  ✅ 3.2: Dynamic Context Filtering")
            else:
                print("  ❌ 3.2: Dynamic Context Filtering - Methods not found")
        else:
            print("  ❌ 3.2: Dynamic Context Filtering - Service file not found")
        ...
        if context_builder_file.exists():
            ...
            if "_context_prioritization_service" in content and "_context_filtering_service" in content:
                print("  ✅ Integration: Context Builder integrates Phase 3 services")
            else:
                print("  ❌ Integration: Context Builder - Phase 3 services not integrated")
