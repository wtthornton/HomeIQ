"""
YAML Validation Service Client for HA AI Agent Service

Epic 51, Story 51.5: Integrate Validation Service with HA Agent Service
...
class YAMLValidationClient:
    ...
    async def validate_yaml(
        self, yaml_content: str, normalize: bool = True, validate_entities: bool = True, validate_services: bool = False
    ) -> dict[str, Any]:
        """
    ...
    async def normalize_yaml(self, yaml_content: str) -> dict[str, Any]:
        ...
        result = await self.validate_yaml(
            yaml_content=yaml_content, normalize=True, validate_entities=False, validate_services=False
        )
        return {
