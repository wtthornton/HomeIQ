...
# Created: 2026-02-05T14:19:34.653081

set -e

SERVICE_DIR="C:\cursor\HomeIQ\services\ha-ai-agent-service"
BACKUP_DIR="C:\cursor\HomeIQ\services\ha-ai-agent-service\.migration_backup_tenacity_20260205_141928"

echo "Rolling back tenacity migration for ha-ai-agent-service..."
