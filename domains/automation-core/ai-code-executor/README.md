...
```bash
cd domains/automation-core/ai-code-executor
...
```bash
docker build -t homeiq-code-executor -f domains/automation-core/ai-code-executor/Dockerfile .
...
```
domains/automation-core/ai-code-executor/
├── Dockerfile
├── README.md
├── requirements.txt
└── src/
